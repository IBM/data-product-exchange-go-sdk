# Data Product Hub Go SDK Version 4.1.0
...
## Installation
The current version of this SDK: 4.1.0
...
```
go get -u github.com/IBM/data-product-exchange-go-sdk/v4/dataproducthubapiservicev1
```
